...
//
// FEC cannot be combined with link bonding: SMPTE 2022-7 duplication already provides
// seamless multipath recovery, so a bonded sender with FEC set is rejected.
//
// # Domain and interop
//
